...
Route::get('manage_curriculum',         'Dean\Curriculum@manageCurriculum');
Route::get('view_curriculum/{id}',      'Dean\Curriculum@viewCurriculum');
...
Route::get('add_day_period_list',		'Dean\AddDayPeriod@dayPeriodList');
Route::get('add_day_period/{id}', 		'Dean\AddDayPeriod@addDayPeriod');
Route::get('assign_instructor', 		'Dean\AssignInstructor@index');
Route::get('instructor_sched_list',     'Dean\AssignInstructor@instructorSchedList');
...
Route::post('save_instructor',          'Dean\AssignInstructor@saveInstructor');
...
Route::get('registration',              'Registrar\Registration@newStudent');
...
Route::post('new_student',              'Registrar\Registration@registerNewStudent');
