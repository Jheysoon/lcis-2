						...
						<table class="table">
							...
							@foreach ($sub as $subj)
								<tr>
									...
									<td class="text-center">
										<a href="/add_day_period/{{ $subj->cid }}" {{ empty($subj->status) ? '' : 'disabled' }} class="btn btn-primary btn-xs">Add Day/Period</a> |
										<a href="/delete_classalloc/{{ $subj->cid }}" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure you want to delete ?');">Delete</a>
									</td>
									<td>
